...
#Added constant, the y coordinate of the top row of bricks for Brick init
TOP_Y = GAME_HEIGHT - BRICK_Y_OFFSET - (BRICK_HEIGHT/2)
...
STATE_ACTIVE    = 4
#: state when the player has lost and the game has ended
STATE_LOSE      = 5
#: state when the player has won the game and the game ends
STATE_WIN       = 6
